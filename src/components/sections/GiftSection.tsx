  ...
  return (
    <section className="bg-obsidian px-5 py-24 md:px-10 md:py-32">
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        <p className="body-lg mt-6 text-stone">
          For the people who are hard to shop for — because they already have everything except a
          story.
        </p>
      </Reveal>
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-ivory">
                  ...
                  <p className="mt-1 font-sans text-[0.7rem] font-light text-ivory/80">
                    {gift.blurb}
                  </p>
                  <p className="mt-3 font-sans text-[0.65rem] uppercase tracking-[0.2em] text-champagne">
                    {gift.price}
                  </p>
                </div>
              </div>
