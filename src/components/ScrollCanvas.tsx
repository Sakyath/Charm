...
export function ScrollCanvas({
  ...
  // Progressive load starts only when this section is near the viewport.
  // On small screens we only load every 2nd frame to reduce memory and data use.
  useEffect(() => {
  ...
  }, [active, frameDir, frameCount, reduce]);
