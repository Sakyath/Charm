    ...
    meta: [
      {
        name: "description",
        content:
          "Build your own handmade charm bracelet. Choose up to 5 charms, add an initial, and order on WhatsApp.",
      },
...
function CustomiseComponent() {
  return (
    <>
      <section className="bg-obsidian px-5 pt-16 text-center md:px-10 md:pt-24">
        <Reveal className="mx-auto max-w-2xl">
          ...
          <p className="body-lg mt-6 text-stone">
            No two stories are the same. Neither are our bracelets.
          </p>
        </Reveal>
      </section>
