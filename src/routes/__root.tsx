...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-obsidian px-5 text-center">
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <Navbar />
      <main key={pathname} className={pathname === "/" ? undefined : "pt-24 md:pt-28"}>
        <Outlet />
      </main>
